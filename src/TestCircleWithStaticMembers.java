public class TestCircleWithStaticMembers {
    public static void main(String[] args) {
        ...
        System.out.println("Объект c1. Радиусом " + c1.radius + " Количество объектов типа Circle - " + Circle.numberOfObjects + " шт.");
        ...
        System.out.println("Объект c2. Радиусом " + c2.radius + " Количество объектов типа Circle - " + Circle.numberOfObjects + " шт.");
